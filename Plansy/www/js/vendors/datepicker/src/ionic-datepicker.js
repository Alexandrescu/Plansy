...
.directive('ionicDatepicker', ['$ionicPopup', function ($ionicPopup) {
    return {
        ...
        scope: {
            ipDate: '=idate',
            selectOnlyFromTodayOn: '=selectOnlyFromTodayOn',
            selectedDateChanged: '&'
        },
        link: function (scope, element, attrs) {
          ...
          "August", "September", "October", "November", "December"];
            ...
            var originalDate = angular.copy(scope.ipDate);
            var selectOnlyFromTodayOnFlagFlag = angular.copy(scope.selectOnlyFromTodayOn);
            ...
            var refreshDateList = function (current_date) {
                ...
                for (var i = firstDay; i <= lastDay; i++) {
                    ...
                    scope.dayList.push({
                        ...
                        isSelectable: (!selectOnlyFromTodayOnFlagFlag || (tempDate.getTime() >= originalDate.getTime()))
                    });
                }
            ...
            scope.dateSelected = function (date) {
                if (typeof date !== 'undefined' && typeof date.date !== 'undefined') {
                        ...
                        },
                        {
                            ...
                            onTap: function (e) {
                                ...
                                if (scope.date_selection.selected === true) {
                                    ...
                                    scope.selectedDateChanged()(scope.ipDate);
                                } else {
                                    e.preventDefault();
                                }
                            }
