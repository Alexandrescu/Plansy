...
namespace MaProgramez.Website.Controllers
{
    public partial class ReportController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult TodaySchedulesPdf()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.TodaySchedulesPdf);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string TodaySchedulesPdf = "TodaySchedulesPdf";
        ...
        public class ActionNameConstants
        {
            ...
            public const string TodaySchedulesPdf = "TodaySchedulesPdf";
            public const string RedirectToConfirmation = "RedirectToConfirmation";
        }


        static readonly ActionParamsClass_DatePicker s_params_DatePicker = new ActionParamsClass_DatePicker();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_DatePicker DatePickerParams { get { return s_params_DatePicker; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_DatePicker
        {
            public readonly string model = "model";
        }
        static readonly ActionParamsClass_TodaySchedulesPdf s_params_TodaySchedulesPdf = new ActionParamsClass_TodaySchedulesPdf();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_TodaySchedulesPdf TodaySchedulesPdfParams { get { return s_params_TodaySchedulesPdf; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_TodaySchedulesPdf
        {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string DatePicker = "DatePicker";
                public readonly string DaySchedule = "DaySchedule";
            }
            public readonly string DatePicker = "~/Views/Report/DatePicker.cshtml";
            public readonly string DaySchedule = "~/Views/Report/DaySchedule.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ReportController : MaProgramez.Website.Controllers.ReportController
    {
        ...
        [NonAction]
        partial void DatePickerOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.ViewModels.ReportViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult DatePicker(MaProgramez.Website.ViewModels.ReportViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.DatePicker);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            DatePickerOverride(callInfo, model);
            return callInfo;
        }

        [NonAction]
        partial void TodaySchedulesPdfOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int? slotId);

        [NonAction]
        public override System.Web.Mvc.ActionResult TodaySchedulesPdf(int? slotId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.TodaySchedulesPdf);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "slotId", slotId);
            TodaySchedulesPdfOverride(callInfo, slotId);
            return callInfo;
        }
