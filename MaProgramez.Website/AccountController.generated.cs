...
namespace MaProgramez.Website.Controllers
{
    public partial class AccountController
    {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string ProviderRegister = "ProviderRegister";
            ...
            public readonly string ActivateAccountConfirmation = "ActivateAccountConfirmation";
        ...
        public class ActionNameConstants
        {
            ...
            public const string ProviderRegister = "ProviderRegister";
            ...
            public const string ActivateAccountConfirmation = "ActivateAccountConfirmation";
        ...
        static readonly ActionParamsClass_ProviderRegister s_params_ProviderRegister = new ActionParamsClass_ProviderRegister();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_ProviderRegister ProviderRegisterParams { get { return s_params_ProviderRegister; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_ProviderRegister
        {
            public readonly string model = "model";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _ProviderRegister = "_ProviderRegister";
                ...
                public readonly string ConfirmEmail = "ConfirmEmail";
                public readonly string Cookies = "Cookies";
                public readonly string CookiesRo = "CookiesRo";
                public readonly string Disclaimer = "Disclaimer";
                ...
                public readonly string ForgotPassword = "ForgotPassword";
                public readonly string ForgotPasswordConfirmation = "ForgotPasswordConfirmation";
                public readonly string LoginLayout = "LoginLayout";
                ...
                public readonly string SendCode = "SendCode";
                public readonly string Terms = "Terms";
                public readonly string TermsRo = "TermsRo";
                public readonly string VerifyCode = "VerifyCode";
            }
            ...
            public readonly string _ProviderRegister = "~/Views/Account/_ProviderRegister.cshtml";
            ...
            public readonly string ActivateAccount = "~/Views/Account/ActivateAccount.cshtml";
            public readonly string ActivateAccountConfirmation = "~/Views/Account/ActivateAccountConfirmation.cshtml";
            public readonly string ConfirmEmail = "~/Views/Account/ConfirmEmail.cshtml";
            public readonly string Cookies = "~/Views/Account/Cookies.cshtml";
            public readonly string CookiesRo = "~/Views/Account/CookiesRo.cshtml";
            public readonly string Disclaimer = "~/Views/Account/Disclaimer.cshtml";
            ...
            public readonly string LoginLayout = "~/Views/Account/LoginLayout.cshtml";
            public readonly string Manage = "~/Views/Account/Manage.cshtml";
            public readonly string PrivacyStatement = "~/Views/Account/PrivacyStatement.cshtml";
            ...
            public readonly string Terms = "~/Views/Account/Terms.cshtml";
            public readonly string TermsRo = "~/Views/Account/TermsRo.cshtml";
            public readonly string VerifyCode = "~/Views/Account/VerifyCode.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : MaProgramez.Website.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.RegisterViewModel model, string returnUrl);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(MaProgramez.Website.Models.RegisterViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void ProviderRegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult ProviderRegister()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ProviderRegister);
            ProviderRegisterOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void ProviderRegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.CreateUserViewModel model, System.Web.HttpPostedFileBase file);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ProviderRegister(MaProgramez.Website.Models.CreateUserViewModel model, System.Web.HttpPostedFileBase file)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ProviderRegister);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "file", file);
            ProviderRegisterOverride(callInfo, model, file);
            return System.Threading.Tasks.Task.FromResult(callInfo as ActionResult);
        }
        ...
        [NonAction]
        partial void VerifyCodeOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.VerifyCodeViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> VerifyCode(MaProgramez.Website.Models.VerifyCodeViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.VerifyCode);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.RegisterViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Register(MaProgramez.Website.Models.RegisterViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ForgotPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.ForgotPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ForgotPassword(MaProgramez.Website.Models.ForgotPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ForgotPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ResetPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.ResetPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ResetPassword(MaProgramez.Website.Models.ResetPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ResetPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ActivateAccountOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string userId, string code);

        [NonAction]
        public override System.Web.Mvc.ActionResult ActivateAccount(string userId, string code)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ActivateAccount);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "userId", userId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "code", code);
            ActivateAccountOverride(callInfo, userId, code);
            return callInfo;
        }

        [NonAction]
        partial void ActivateAccountOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.ResetPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ActivateAccount(MaProgramez.Website.Models.ResetPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ActivateAccount);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ActivateAccountOverride(callInfo, model);
            return System.Threading.Tasks.Task.FromResult(callInfo as ActionResult);
        }

        [NonAction]
        partial void ActivateAccountConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult ActivateAccountConfirmation()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ActivateAccountConfirmation);
            ActivateAccountConfirmationOverride(callInfo);
            return callInfo;
        }
        ...
        [NonAction]
        partial void SendCodeOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.SendCodeViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> SendCode(MaProgramez.Website.Models.SendCodeViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.SendCode);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MaProgramez.Website.Models.ExternalLoginConfirmationViewModel model, string returnUrl);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ExternalLoginConfirmation(MaProgramez.Website.Models.ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ExternalLoginConfirmation);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "returnUrl", returnUrl);
        ...
        [NonAction]
        partial void CookiesOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Cookies()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Cookies);
            CookiesOverride(callInfo);
            return callInfo;
        }
