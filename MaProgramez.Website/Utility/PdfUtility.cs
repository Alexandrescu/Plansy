...
namespace MaProgramez.Website.Utility
{
    public class PdfView : IView, IViewEngine
    {
        ...
        public PdfView(ViewEngineResult result, string path)
        {
            _result = result;
            _path = path;
        }
    ...
    public class PdfSaveResult : ViewResult
    {
        //Constructors
        public PdfSaveResult(object model, string name, string path)
        {
        ...
        protected override ViewEngineResult FindView(ControllerContext context)
        {
            ...
            var pdfView = new PdfView(result, PathName);
